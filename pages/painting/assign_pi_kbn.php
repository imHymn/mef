                            ...
                            <table class="custom-hover table" style="table-layout: fixed; min-width: 1200px; width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 10%; text-align: center; white-space: normal; word-wrap: break-word;">Action<span class="sort-icon"></span></th>
                                    </tr>
                                </thead>
    ...
    <script>
                ...
                .then(data => {
                    ...
                    filteredDeliveryData = filteredDeliveryData.filter(item => {
                        ...
                        if (userRole === 'supervisor' || userRole === 'line leader') {
                            ...
                            // For all other sections → check production_location
        ...
        function renderPaginatedTable(pageData) {
            ...
            <td style="text-align: center;" class="sticky-col col-1">
                <span style="cursor: pointer; margin-right: 12px;" onclick="handleRefresh('${item.id}','assembly','${item.assembly_section}','reset')">🔄</span>
            </td>
  ...
  >
        ...
        document.getElementById('time-in-btn').addEventListener('click', () => {
            ...
            const selectedItems = [...checked].map(cb => ({
                ...
                model_name: cb.dataset.model_name,
