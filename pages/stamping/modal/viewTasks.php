 ...
 <td class="text-center">${item.quantity ?? ''}</td>
  ...
  `;
    ...
    function assign(id, by_order, full_name, section) {
        ...
        fetch('api/stamping/assignOperator', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
            ...
            .then(data => {
                if (data.success) {
                    ...
                    // Optional: reload after a short delay to allow alert to show
    ...
    function enableDragAndDrop() {
        ['#stamping-tasks-table tbody'].forEach(selector => {
