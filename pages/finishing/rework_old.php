    ...
    <script>
        ...
        function renderTable(pageData, currentPage) {
          ...
          <button class="btn btn-sm btn-warning time-out-btn"
            ...
            TIME OUT
                ...
                <span style="cursor: pointer" onclick="handleRefresh('${item.id}','assembly','${item.assembly_section}','reset')">🔄</span>
            </td>
      ...
      `;
        ...
        function getData(model) {
            fetch(`api/assembly/getRework.php?model=${encodeURIComponent(model)}`)
